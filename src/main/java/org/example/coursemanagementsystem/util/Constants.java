...
public class Constants {
    ...
    public static final String EMAIL_ALREADY_EXISTS = "Bu email artıq qeydiyyatdan keçib!";
    public static final String FIN_ALREADY_EXISTS = "Bu FİN kod artıq sistemdə mövcuddur!";
